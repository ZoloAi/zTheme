...
(function() {
    ...
    function initValidation() {
        ...
        console.log(`[OK] zTheme: Initialized validation for ${forms.length} form(s)`);
    }
    ...
    function initAccordion() {
        // Event delegation: handles accordions rendered dynamically after page load
        if (document._zAccordionDelegated) return;
        document._zAccordionDelegated = true;

        document.addEventListener('click', function(e) {
            const button = e.target.closest('.zAccordion-button');
            if (!button) return;
            ...
            if (!item) return;
            const accordion = item.closest('.zAccordion');
            if (!accordion) return;
            ...
            // Close all panels in this accordion group
            accordion.querySelectorAll('.zAccordion-collapse').forEach(p => p.classList.add('zCollapsed'));
            accordion.querySelectorAll('.zAccordion-button').forEach(b => {
        ...
        console.log('[OK] zTheme: Accordion delegation initialized');
    }
    ...
    function initCarousel() {
        ...
        console.log(`[OK] zTheme: Initialized ${carousels.length} carousel(s)`);
    }
    ...
    function initCollapse() {
        ...
        console.log(`[OK] zTheme: Initialized ${triggers.length} collapse trigger(s)`);
    }
    ...
    function initNavbarDropdowns() {
        ...
        console.log(`[OK] zTheme: Initialized ${navbarDropdowns.length} navbar dropdown(s)`);
    }
    ...
    function initDropdown() {
        ...
        console.log(`[OK] zTheme: Initialized ${toggles.length} dropdown(s)`);
    }
    ...
    function initListGroup() {
        ...
        console.log(`[OK] zTheme: Initialized ${triggers.length} list group tab(s)`);
    }
    ...
    function initModal() {
        ...
        console.log(`[OK] zTheme: Initialized ${triggers.length} modal(s)`);
    }
    ...
    function initOffcanvas() {
        ...
        console.log(`[OK] zTheme: Initialized ${triggers.length} offcanvas panel(s)`);
    }
    ...
    function initPopover() {
        ...
        console.log(`[OK] zTheme: Initialized ${triggers.length} popover(s)`);
    }
    ...
    function initScrollspy() {
        ...
        console.log(`[OK] zTheme: Initialized ${spyElements.length} scrollspy element(s)`);
    }
    ...
    function initToast() {
        ...
        console.log(`[OK] zTheme: Initialized ${toasts.length} toast(s)`);
    ...
    function initTooltip() {
        ...
        console.log(`[OK] zTheme: Initialized ${triggers.length} tooltip(s)`);
    }
    ...
    function initTabs() {
        ...
        console.log(`[OK] zTheme: Initialized ${tabTriggers.length} tab(s)`);
    }
    ...
    function initRangeSliders() {
        ...
        if (initializedCount > 0) {
            console.log(`[OK] zTheme: Initialized ${initializedCount} range slider(s) with value displays`);
        }
    }
    ...
    function init() {
        ...
        console.log('[OK] zTheme: JavaScript initialization complete');
    }
